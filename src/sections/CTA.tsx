...
export function CTA() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-r from-vinho-500/10 via-transparent to-vinho-600/10 rounded-3xl blur-3xl" aria-hidden="true" />
        
        {!reducedMotion && (
          <>
            <div className="absolute -top-8 -left-8 w-24 h-24 border-2 border-vinho-500/30 rounded-full animate-pulse" aria-hidden="true" />
            <div className="absolute -bottom-8 -right-8 w-16 h-16 border-2 border-vinho-600/30 rounded-full animate-pulse" style={{ animationDelay: '1s' }} aria-hidden="true" />
          </>
        )}
        ...
        <div className="relative z-10 px-6 lg:px-12 py-12 lg:py-16">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-vinho-500/10 border border-vinho-500/20 text-vinho-400 text-sm font-medium mb-6"
          >
          ...
          <motion.p
            ...
            className="text-neutral-300 text-lg lg:text-xl max-w-2xl mx-auto mb-10"
          >

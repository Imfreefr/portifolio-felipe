  ...
  return (
    ...
    >
          ...
          return (
            ...
            >
              ...
              <div className="relative z-10 flex items-start gap-4">
                <div className="flex-shrink-0 w-11 h-11 rounded-xl bg-vinho-500/10 group-hover:bg-vinho-500/20 transition-colors flex items-center justify-center">
                  <Icon className="w-5 h-5 text-vinho-400 group-hover:scale-110 transition-transform duration-300" aria-hidden="true" />
                </div>
                ...
                <motion.div
                  ...
                  className="flex-shrink-0 w-5 h-5 text-emerald-400 opacity-0 group-hover:opacity-100 transition-opacity"
                  aria-hidden="true"
                >
      ...
      <motion.div
        ...
        className="mt-16"
      >
        <div className="bg-preto-900/60 backdrop-blur-sm border border-preto-700 rounded-2xl p-8 lg:p-12">
          <div className="max-w-3xl mx-auto text-center">
            <motion.div
              initial={{ scale: 0.9, opacity: 0 }}
              animate={{ scale: 1, opacity: 1 }}
              transition={{ duration: reducedMotion ? 0 : 0.5, delay: 0.6 }}
              className="inline-flex items-center gap-3 px-6 py-3 rounded-full bg-vinho-500/10 border border-vinho-500/20 mb-6"
            >
              ...
              <span className="text-vinho-400 font-medium">Compromisso com qualidade e entrega</span>
            </motion.div>
